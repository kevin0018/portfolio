...
const Hero: React.FC<HeroProps> = ({ idioma, setIdioma, onDownClick }) => {
    ...
    return (
        <section className="relative flex flex-col min-h-screen w-full bg-white text-black dark:bg-black dark:text-white justify-center items-center transition-colors duration-500">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center w-full max-w-3xl mx-auto">
                ...
                <div className="flex-shrink-0 mb-8 md:mb-0 md:mr-12">
                    <div className="w-32 h-32 rounded-full overflow-hidden border-4 border-teal-400 shadow-lg bg-gray-100 dark:bg-white/10 flex items-center justify-center">
                        <img
                ...
                <div className="flex flex-col items-center md:items-start">
                    <span className="text-teal-600 dark:text-teal-400 tracking-widest font-bold mb-2 uppercase">{textos[idioma].about}</span>
                    ...
                    <div className="flex gap-4 mb-4">
                        {/* GitHub */}
                        <a href="#" className="text-teal-600 dark:text-teal-400 hover:text-teal-500 dark:hover:text-teal-300" aria-label="GitHub">
                        ...
                        {/* LinkedIn */}
                        <a href="#" className="text-teal-600 dark:text-teal-400 hover:text-teal-500 dark:hover:text-teal-300" aria-label="LinkedIn">
                            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
