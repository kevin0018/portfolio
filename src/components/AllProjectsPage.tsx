        ...
        <div className="min-h-screen bg-gray-50 dark:bg-neutral-900 py-8">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="relative">
                    ...
                    <div className="bg-white dark:bg-neutral-800 rounded-3xl shadow-xl overflow-hidden border border-gray-200 dark:border-neutral-700 w-full max-w-7xl mx-auto h-[500px]">
                        <div className="flex flex-col lg:flex-row h-full">
                            {/* Project image - larger fixed size */}
                            <div className="lg:w-3/5 relative overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100 dark:from-neutral-700 dark:to-neutral-600 flex items-center justify-center h-full">
                                <div className="w-[500px] h-[400px] bg-white dark:bg-neutral-800 rounded-xl shadow-lg p-4 flex items-center justify-center">
                                    <img
                            ...
                            {/* Project content */}
                            <div className="lg:w-2/5 p-6 lg:p-8 flex flex-col justify-center h-full">
                                <div className="mb-4">
                                ...
                                <div className="mb-6">
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        {currentProjectData.languages.map((tech, index) => {
                                            ...
                                            return (
                                                <div key={index} className="flex items-center gap-1.5 bg-gray-100 dark:bg-neutral-700 px-3 py-1.5 rounded-lg text-sm">
                                                    {skill?.icon && (
                                                        <span
                                ...
                                <div className="flex flex-col sm:flex-row gap-3">
                                    ...
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="flex-1 bg-gray-800 dark:bg-gray-700 hover:bg-gray-900 dark:hover:bg-gray-600 text-white py-3 px-4 rounded-lg font-medium transition-colors inline-flex items-center justify-center gap-2"
                                    >
