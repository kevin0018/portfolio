            ...
            <div className="w-full max-w-5xl">
                ...
                >
                    {projects.map((project, i) => (
                        <SwiperSlide key={i}>
                            <div
                                className="bg-white dark:bg-neutral-900 border border-gray-200 dark:border-neutral-700 rounded-2xl shadow-lg flex flex-col h-full w-80 overflow-hidden mx-auto transition-all"
                            >
                                <img
                                    src={project.image}
                                    alt={project.name}
